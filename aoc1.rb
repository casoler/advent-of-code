...
def get_coordinates(direction, coordinates, this_blocks)
  if direction == 0
    coordinates[0] = coordinates[0] + this_blocks
  elsif direction == 90
    coordinates[1] = coordinates[1] + this_blocks
  elsif direction == 180
    coordinates[0] = coordinates[0] - this_blocks
  elsif direction == 270
    coordinates[1] = coordinates[1] - this_blocks
...
instructions.each do |instruction|
  ...
  coordinates = get_coordinates(direction, coordinates, this_blocks)
end
